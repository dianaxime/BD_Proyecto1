...
"color: rgb(236, 236, 236);")
        ...
        #self.nombreInput.setText("Hola bitches")
...
"color: rgb(72, 72, 72);")
        ...
        self.continuarButton.clicked.connect(self.buscarArtista)
        ...
        try:
            ...
            if nombre != '' :
                ...
                if (len(IDArtO)==0):
                    ...
                    blank.setText("El artista que usted quiere modificar no esta registrado")
                    blank.exec()
                else:
                    IDArtO=IDArtO[0][0]
                    print(IDArtO)
                    ...
                    #self.id=IDArtO
                    self.ui = Ui_ModificarArtista(self.id,IDArtO )
...
if __name__ == "__main__":
    ...
    ui.setupUi(Form)
    Form.show()
    Form.setWindowTitle("Buscar Artista")
    sys.exit(app.exec_())
