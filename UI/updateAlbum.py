...
# Form implementation generated from reading ui file 'updateAlbum.ui'
#
...
class Ui_UpdateAlbum(object):
    def setupUi(self, Form):
        ...
        nombreColumnas = ("old_title", "new_title","old_artist", "new_artist","User")
...
"color: rgb(72, 72, 72);")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Historial Album"))
        self.tituloLabel.setText(_translate("Form", "Especificaciones Update Album"))
    ...
    def conectarDB(self):
        ...
        try:
            ...
            cur.execute('''SELECT * FROM album_historial''')
            #Insertamos los datos devueltos por la consulta en la tabla
            row = 0
            for x,a,b,c,d,e in cur.fetchall():
